...
function showButtonClick() { //버킷 박스 버튼
    if (Number(bucketBox.style.opacity) > 0) {
        bucketBox.style.opacity = 0 ;
    }else {
        bucketBox.style.opacity = 0.9 ;
    }
}
bucketVisible.addEventListener("click",showButtonClick);
